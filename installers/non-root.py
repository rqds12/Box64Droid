...
def packages():
    ...
    os.system("pkg install pulseaudio wget xkeyboard-config proot-distro termux-x11-nightly termux-am -y &>/dev/null")
...
def clear_waste():
    os.system("rm box64droid-rootfs.tar.xz install non-root.py")
    os.system("clear")
def storage():
